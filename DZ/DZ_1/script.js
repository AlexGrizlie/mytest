...
function this2() {
    ...
    var person2 = {person.name: 'Маша'; person.nation: 'ukraine'; person.age: '24'};
    var person3 = {person.name: 'Петя'; person.nation: 'ukraine'; person.age: '24'};
    var person4 = {person.name: 'Лена'; person.nation: 'ukraine'; person.age: '17'};
    var person5 = {person.name: 'Даша'; person.nation: 'ukraine'; person.age: '45'};
